...
const NavLink = ({ href, children }: { href: string; children: React.ReactNode }) => (
    <Link href={href} className="text-muted-foreground transition-colors hover:text-foreground px-3 py-2">
        {children}
    </Link>
);
...
const NavDropdown = () => (
    <DropdownMenu>
        <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="text-muted-foreground hover:text-foreground px-3 py-2">
    ...
    <header className="sticky top-0 z-50 w-full p-4">
      <div className="mx-auto flex h-14 max-w-screen-xl items-center justify-between gap-4">
        ...
        <div className="flex items-center justify-start">
            <Link href="/" className="flex h-full items-center gap-3 rounded-full border border-border/40 bg-background/80 px-4 py-2 shadow-lg backdrop-blur-sm transition-colors hover:bg-muted/50">
                {loadingLogo ? (
        ...
        <div className="flex items-center justify-end">
             <div className="flex h-full items-center gap-2 rounded-full border border-border/40 bg-background/80 px-4 py-2 shadow-lg backdrop-blur-sm">
                <ThemeToggle />
