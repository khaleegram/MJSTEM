        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              See the journal's <Link href="/ethics-policies" className="text-primary hover:underline">Privacy Statement</Link>, which assures readers that their name and email address will not be used for other purposes.
            </p>
          </CardContent>
        </Card>
      </div>
